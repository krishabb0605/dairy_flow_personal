    ...
    <td className='px-6 py-4 text-center'>
      {isEditing ? (
        <input
          ...
          className='w-full max-w-[220px] mx-auto h-9 px-3 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-primary focus:border-primary focus-visible:outline-primary/50'
